...
use Pim\Bundle\CatalogVolumeMonitoringBundle\Persistence\Query\Sql\SqlCategoryTrees;
...
class SqlCategoryTreesSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(SqlCategoryTrees::class);
    }
    ...
    function it_gets_average_and_max_volume($connection, Statement $statement)
    {
        ...
        $this->fetch()->shouldBeLike(new CountVolume(4, 12, 'category_trees'));
    }
}
