...
use Pim\Bundle\CatalogVolumeMonitoringBundle\Persistence\Query\Sql\SqlVariantProducts;
...
class SqlVariantProductsSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(SqlVariantProducts::class);
    }
