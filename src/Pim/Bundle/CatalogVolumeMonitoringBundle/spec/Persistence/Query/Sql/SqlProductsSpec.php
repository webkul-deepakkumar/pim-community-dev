...
use Pim\Bundle\CatalogVolumeMonitoringBundle\Persistence\Query\Sql\SqlProducts;
...
class SqlProductsSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(SqlProducts::class);
    }
