...
use Pim\Bundle\CatalogVolumeMonitoringBundle\Persistence\Query\Sql\SqlOptionsPerAttribute;
...
class SqlOptionsPerAttributeSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(SqlOptionsPerAttribute::class);
    }
    ...
    function it_gets_average_and_max_volume($connection, Statement $statement)
    {
        ...
        $this->fetch()->shouldBeLike(new AverageMaxVolumes(10, 4, 12, 'options_per_attribute'));
    }
}
