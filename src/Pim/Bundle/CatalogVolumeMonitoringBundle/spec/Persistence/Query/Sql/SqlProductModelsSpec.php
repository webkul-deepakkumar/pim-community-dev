...
use Pim\Bundle\CatalogVolumeMonitoringBundle\Persistence\Query\Sql\SqlProductModels;
...
class SqlProductModelsSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(SqlProductModels::class);
    }
    ...
    function it_gets_average_and_max_volume($connection, Statement $statement)
    {
        ...
        $this->fetch()->shouldBeLike(new CountVolume(4, 12, 'product_models'));
    }
}
