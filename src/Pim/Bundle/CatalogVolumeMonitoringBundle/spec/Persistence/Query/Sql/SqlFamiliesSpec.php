...
use Pim\Bundle\CatalogVolumeMonitoringBundle\Persistence\Query\Sql\SqlFamilies;
...
class SqlFamiliesSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(SqlFamilies::class);
    }
    ...
    function it_gets_average_and_max_volume($connection, Statement $statement)
    {
        ...
        $this->fetch()->shouldBeLike(new CountVolume(4, 12, 'families'));
    }
}
