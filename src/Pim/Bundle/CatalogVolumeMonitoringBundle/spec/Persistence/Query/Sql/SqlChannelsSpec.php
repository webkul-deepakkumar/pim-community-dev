...
use Pim\Bundle\CatalogVolumeMonitoringBundle\Persistence\Query\Sql\SqlChannels;
...
class SqlChannelsSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(SqlChannels::class);
    }
