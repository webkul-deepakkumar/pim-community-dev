...
use Pim\Bundle\CatalogVolumeMonitoringBundle\Persistence\Query\Sql\SqlAttributes;
...
class SqlAttributesSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(SqlAttributes::class);
    }
