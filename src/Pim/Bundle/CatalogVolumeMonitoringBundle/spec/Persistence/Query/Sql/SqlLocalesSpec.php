...
use Pim\Bundle\CatalogVolumeMonitoringBundle\Persistence\Query\Sql\SqlLocales;
...
class SqlLocalesSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(SqlLocales::class);
    }
