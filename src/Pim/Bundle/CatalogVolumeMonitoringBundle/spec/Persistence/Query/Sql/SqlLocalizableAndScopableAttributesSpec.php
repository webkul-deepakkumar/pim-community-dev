...
use Pim\Bundle\CatalogVolumeMonitoringBundle\Persistence\Query\Sql\SqlLocalizableAndScopableAttributes;
...
class SqlLocalizableAndScopableAttributesSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(SqlLocalizableAndScopableAttributes::class);
    }
    ...
    function it_gets_average_and_max_volume($connection, Statement $statement)
    {
        ...
        $this->fetch()->shouldBeLike(new CountVolume(4, 12, 'localizable_and_scopable_attributes'));
    }
}
