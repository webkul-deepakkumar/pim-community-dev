...
use Pim\Bundle\CatalogVolumeMonitoringBundle\Persistence\Query\Sql\SqlLocalizableAttributes;
...
class SqlLocalizableAttributesSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(SqlLocalizableAttributes::class);
    }
