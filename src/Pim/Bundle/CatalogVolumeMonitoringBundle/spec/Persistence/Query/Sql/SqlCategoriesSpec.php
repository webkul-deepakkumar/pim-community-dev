...
use Pim\Bundle\CatalogVolumeMonitoringBundle\Persistence\Query\Sql\SqlCategories;
...
class SqlCategoriesSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(SqlCategories::class);
    }
