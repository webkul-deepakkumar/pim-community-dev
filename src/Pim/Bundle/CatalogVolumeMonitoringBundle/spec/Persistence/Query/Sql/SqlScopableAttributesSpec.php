...
use Pim\Bundle\CatalogVolumeMonitoringBundle\Persistence\Query\Sql\SqlScopableAttributes;
...
class SqlScopableAttributesSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(SqlScopableAttributes::class);
    }
    ...
    function it_gets_average_and_max_volume($connection, Statement $statement)
    {
        ...
        $this->fetch()->shouldBeLike(new CountVolume(4, 12, 'scopable_attributes'));
    }
}
