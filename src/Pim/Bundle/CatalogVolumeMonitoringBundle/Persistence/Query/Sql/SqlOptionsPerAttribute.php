 ...
 */
class SqlOptionsPerAttribute implements AverageMaxQuery
{
    ...
    public function fetch(): AverageMaxVolumes
    {
        $sql = <<<SQL
            ...
            FROM (
                SELECT COUNT(ao.id) count_options_per_attribute
                FROM pim_catalog_attribute_option ao
                  INNER JOIN pim_catalog_attribute AS a ON ao.attribute_id = a.id
